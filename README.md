...
build 打包后index.html入口页引用的资源路径为: <script src="./assets/main.js"></script></body>
...
devServer配置的publicPath：webpack-dev-server执行后访问路径为 http://localhost:8080/base/index.html
